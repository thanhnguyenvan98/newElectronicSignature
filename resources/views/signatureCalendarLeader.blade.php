            ...
            <form>
                <div class="modal-body">
                    <div class="card-body">
                        ...
                        <h5 class="card-title" style="margin-top: 20px">trưởng khoa : Chưa ký</h5>
                        <h5 class="card-title" style="margin-top: 20px">Nhập khóa</h5>
                        <div class="input-group"><input type="text" class="form-control" style="height: 42px" placeholder="Nhập khóa của bạn hoặc chọn file(txt) chứa khóa">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary">Ký</button>
                </div>
            </form>
        </div>
    </div>
